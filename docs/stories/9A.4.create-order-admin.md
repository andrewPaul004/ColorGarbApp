...
- [ ] Admin create order form accessible from admin dashboard
- [ ] Organization selection dropdown with search functionality works
- [ ] All enhanced fields (order name, performer count, etc.) validate correctly
- [ ] Manufacturing stage selection allows starting at any valid stage
- [ ] Invoice import successfully uploads PDF and extracts amount
- [ ] Order creation succeeds with proper audit logging
- [ ] Created orders appear in both admin and organization views
- [ ] Email notifications sent with admin creation context
- [ ] Mobile-responsive design works on admin interface
- [ ] Unit and integration tests cover admin order creation
